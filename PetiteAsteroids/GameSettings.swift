...
struct GameSettings {
    ...
    static let menuAppearDelay: Float = 2
    static let butteRiseAnimationInitialOffset = GameSettings.volumeSize.height * 1.25
    static let butteRiseSpeechBubbleAppearDelay: Float = 2
    static let butteRiseSpeechBubbleAppearDuration: Float = 3
    static let butteRiseAnimationDuration: Float = 5
    static let butteFadeInAnimationDuration: Float = 2
    static let butteFadeOutAnimationDuration: Float = 4
    static let gamePlayStartAnimationDuration: Float = butteRiseAnimationDuration + butteFadeInAnimationDuration
    // MARK: Fade
