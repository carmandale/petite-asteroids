...
struct BakedDirectionalLightShadowSystem: System {
    ...
    init(scene: Scene) {
        scene.subscribe(to: ComponentEvents.DidAdd.self,
                        componentType: RockPickupComponent.self,
                        onDidAddRockPickupComponent).store(in: &subscriptions)
        scene.subscribe(to: ComponentEvents.DidAdd.self,
                        componentType: CharacterAnimationComponent.self,
                        onDidAddCharacterAnimationComponent).store(in: &subscriptions)
